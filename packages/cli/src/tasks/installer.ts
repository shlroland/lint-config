...
const lintToolsPkgs = {
  [LintTools.ESLINT]: ['eslint', '@shlroland/eslint-config'],
  [LintTools.CZG]: ['czg', '@shlroland/commitlint-config'],
  [LintTools.COMMITLINT]: ['commitlint', '@shlroland/commitlint-config'],
